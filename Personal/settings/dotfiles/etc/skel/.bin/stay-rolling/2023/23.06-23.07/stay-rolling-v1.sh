...
echo "INSTALLATIONS"
echo "###############################################################################"
echo "We have added these packages on the iso :"
echo
echo "- sofirem-git"
echo "- arcolinux-app-glade-git"
echo "- noconfirm noto-fonts-emoji"
echo
sudo pacman -S --noconfirm sofirem-git
sudo pacman -S --noconfirm arcolinux-app-glade-git
