...
echo "###############################################################################"
echo "WE WILL USE A DIFFERENT SETTING IN THE PACMAN.CONF"
echo "SigLevel = Optional TrustedOnly"
echo "This will be the default setting from now on"
echo "You can change if you want or keep the current setting"
echo "https://archlinux.org/pacman/pacman.conf.5.html#SC"
echo "Both (optional and trustedonly) are the default settings"
echo "###############################################################################"
echo
