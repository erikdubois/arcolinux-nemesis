...
echo
echo "Getting rid of those annoying warning message that will never be removed by Arch"
sudo pacman -S --needed --noconfirm aic94xx-firmware
sudo pacman -S --needed --noconfirm upd72020x-fw
sudo pacman -S --needed --noconfirm wd719x-firmware
echo
echo "###############################################################################"
