...
echo "REMOVALS"
echo "###############################################################################"
echo "We remove the libadwaita-without-adwaita-git package"
function_remove_dd libadwaita-without-adwaita-git
echo
echo "None"
echo
echo
...
echo "INSTALLATIONS"
echo "###############################################################################"
echo "We install the libadwaita"
echo "Change the /etc/environment file if you want"
echo
